...
:::tip[Genvejstaster]
For nemmere at indrykke og rykke ud, kan du bruge Tab og Shift+Tab.
...
<img src={import.meta.env.BASE_URL + "images/elsa/4-gentagelser-i-lokker.png"} alt="4-gentagelser-i-lokker.png" class="elsa-screenshot" />
...
Ved at gentage 4 gange kan man få den til at lave en firkant.
