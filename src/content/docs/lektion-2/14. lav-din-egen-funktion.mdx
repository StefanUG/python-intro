---
title: "14. Lav din egen funktion"
sidebar:
  order: 7
---
...
<img src={import.meta.env.BASE_URL + "images/elsa/14-egen-funktion.png"} alt="14-egen-funktion.png" class="elsa-screenshot" />
...
Vi laver 10 cirkler og hopper lidt frem mellem dem.
