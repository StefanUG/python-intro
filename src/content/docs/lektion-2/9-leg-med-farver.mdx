...
<img src={import.meta.env.BASE_URL + "images/elsa/9-leg-med-farver.png"} alt="9-leg-med-farver.png" class="elsa-screenshot" />
...
En hel cirkel er 360 grader. Du laver 90 streger, så regn `360 / 90` ud for at finde drejningen mellem stregerne.
:::
