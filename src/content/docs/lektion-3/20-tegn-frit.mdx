...
<img src={import.meta.env.BASE_URL + "images/elsa/20-tegnfrit.png"} alt="20-tegnfrit.png" class="elsa-screenshot" />
...
Start med én af dine tidligere snefnugfunktioner. Brug `teleport(x, y)` til at vælge, hvor på canvaset den skal tegnes.
:::

<Solution>

Eksempel på fri tegning med to forskellige snefnugfunktioner:
